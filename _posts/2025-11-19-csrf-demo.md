...
<img src='/images/csrf/login-success.png' width="600">
<img src='/images/csrf/login-cookie.png' width="600">
...
```
<img src='/images/csrf/attack-fail.png' width="600">
...
```
<img src='/images/csrf/attack-success.png' width="600">
...
## Takeaways
1. 쿠키의 `Samesite=None`과 `Secure=false` 조합은 브라우저가 거부하는 동작일 수 있다
