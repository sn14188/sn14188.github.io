...
### 종류
1. **Big *O***  
   입력하는 n에 대해 실행 시간이 대략 이 이상은 커지지 않을 것이라는 의미이다. 예를 들어 $$O(n^2)$$은 입력 $$n$$이 증가하더라도 실행 시간의 증가율이 $$n^2$$보다는 작거나 같다는 것을 표현한다.
...
*(출처: [Image](https://www.researchgate.net/figure/A-comparison-of-algorithm-time-complexity_fig1_311754895))*
