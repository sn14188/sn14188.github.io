...
대부분의 현대 파일시스템은 아이노드 또는 그와 동등한 개념의 메타데이터 오브젝트로 동작하기 때문입니다. 이름이나 구현 방식은 다르지만, "파일의 속성과 저장 위치를 별도의 구조로 관리한다"는 아이노드 모델은 거의 모든 시스템에 공통적으로 쓰입니다.
...
(base) aidenseo@Aidens-MacBook-Pro temp % 
```
용량을 살펴보니 64바이트로, 4개 요소들을 합쳐도 고작 94바이트밖에 되지 않는데 상위 디렉터리인 temp는 192바이트나 됩니다. 이유가 무엇일까요?
...
(base) aidenseo@Aidens-MacBook-Pro Desktop % 
```
a.txt의 사이즈가 2379바이트가 된 시점에도 이 파일을 포함하는 디렉터리의 크기는 변하지 않았음을 알 수 있습니다.<br>
...
```bash
(base) aidenseo@Aidens-MacBook-Pro FE % stat -x /Users/aidenseo/Desktop/FE/node_modules/.pnpm/@eslint+eslintrc@3.3.1/node_modules/@eslint/eslintrc/package.json
...
```bash
(base) aidenseo@Aidens-MacBook-Pro 46 % stat -x ~/Library/pnpm/store/v10/files/46/0d3a71c2730014fee1bf2ec3f06923a7cef147162b7e4438990b9a9bc8c7a179aed052ad2ebcd254e830d1b605b8236071fd6c48cffa453cffa3bf74896cff

  File: "/Users/aidenseo/Library/pnpm/store/v10/files/46/0d3a71c2730014fee1bf2ec3f06923a7cef147162b7e4438990b9a9bc8c7a179aed052ad2ebcd254e830d1b605b8236071fd6c48cffa453cffa3bf74896cff"
  Size: 1760         FileType: Regular File
  Mode: (0644/-rw-r--r--)         Uid: (  501/aidenseo)  Gid: (   20/   staff)
Device: 1,15   Inode: 90618308    Links: 1
Access: Thu Nov  6 06:04:36 2025
Modify: Fri Sep 26 13:41:05 2025
Change: Fri Sep 26 13:41:05 2025
 Birth: Fri Sep 26 13:41:05 2025
(base) aidenseo@Aidens-MacBook-Pro 46 % 
```
하지만 예상과 달리, 두 파일의 아이노드 번호는 달랐습니다. 앞선 예에서 `a.txt`의 내용을 수정하고 저장했을 때 아이노드 번호가 바뀌는 현상을 본 적이 있었는데, 검색해보니 macOS의 APFS 파일시스템에서는 동일한 데이터를 공유하더라도 하드 링크가 서로 다른 아이노드를 가질 수 있다고 합니다.<br>
눈에 보이는 "같은 파일" 구조를 직접 확인하지는 못했지만, pnpm이 이러한 시스템 특성을 활용하는 효율적인 패키지 매니저라는 점으로 마무리하고, 또 아이노드에 대해 조금 더 이해하게 된 것으로 만족하려 합니다.
