...
### 이미지에 웹 접근성 구현해보기
먼저 Quick Reference 페이지에서 `images` 필터를 적용해보았습니다.<br><br>
(image)<br><br>
...
그중 가장 위에 있는 "ARIA6: Using aria-label to provide labels for objects" 링크를 클릭해봤습니다.<br><br>
(image)<br><br>
...
이를 통해 단순히 "이미지에 `alt`를 넣어야 한다"를 넘어서 특정 상황에서 어떤 방법을 선택해야 하는지 구체적으로 이해할 수 있습니다.
