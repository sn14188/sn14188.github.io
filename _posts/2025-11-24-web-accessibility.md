...
Screen Reader 같은 기기는 이 접근성 트리를 기반으로 콘텐츠를 이해할 수 있습니다.<br>
...
Screen Reader는 접근성 트리를 통해 이 요소를 "이미지, 도서관에서 책을 읽는 사람"으로 이해합니다.

```html
<img src="photo.png" alt="">
```

Screen Reader는 이 이미지를 건너뛸 수 있습니다.
...
살펴보니 이미지 접근성의 우선 적용 원칙은 `alt` 속성을 사용하는 것임을 다시 확인할 수 있었고,
